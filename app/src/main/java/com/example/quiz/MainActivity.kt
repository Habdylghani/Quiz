...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculateScore(): Int {
        val question1CorrectAnswerId = R.id.option3 // Correct answer for Question 1
        val question1SelectedAnswerId = radioGroup.checkedRadioButtonId

        val question2CorrectAnswers = setOf(R.id.checkboxOption1, R.id.checkboxOption2) // Correct answers for Question 2
